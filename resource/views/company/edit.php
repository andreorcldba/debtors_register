    ...
    <div class="container">    
        <form>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="telephone" placeholder="Seu telefone" maxlength="14">
            </div>
            <div class="form-group">
                <label for="cnpj">Cnpj</label>
                <input type="text" class="form-control" id="cnpj" placeholder="Seu cnpj" maxlength="18">
                <span id="cnpj-error-01" class="text-danger d-none">Este campo é obrigatório</span>
            </div>
